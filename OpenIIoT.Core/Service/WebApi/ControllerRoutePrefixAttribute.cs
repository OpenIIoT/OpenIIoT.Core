...
namespace OpenIIoT.Core.Service.WebApi
{
    ...
    ///     Prepends the configured WebRoot route to all actions within a controller.
    /// </summary>
    public class ControllerRoutePrefixAttribute : RoutePrefixAttribute
    {
        #region Public Constructors

        /// <summary>
        ///     Initializes a new instance of the <see cref="ControllerRoutePrefixAttribute"/> class.
        /// </summary>
        /// <param name="prefix">The route prefix for the controller.</param>
        public ControllerRoutePrefixAttribute(string prefix)
            : base(prefix)
        {
        }

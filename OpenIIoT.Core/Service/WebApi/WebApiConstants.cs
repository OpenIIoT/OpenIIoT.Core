namespace OpenIIoT.Core.Service.WebApi
{
    public static class WebApiConstants
    {
        ...
        public static readonly string[] AnonymousRoutes = { ApiRoutePrefix, SignalRRoutePrefix, HelpRoutePrefix, LoginRoutePrefix, HelpRoutePrefix, NotFoundRoutePrefix, "assets", "node_modules" };

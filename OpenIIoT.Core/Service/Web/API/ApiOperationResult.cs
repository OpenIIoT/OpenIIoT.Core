...
namespace OpenIIoT.Core.Service.Web
{
    ...
    public class ApiResult<T> : Result<T>
    {
        ...
        /// <summary>
        ///     Gets the remote IP address of the original request.
        /// </summary>
        public string RemoteIP => Request.GetOwinContext().Request.RemoteIpAddress;

        /// <summary>
        ///     Gets the HttpRequestMessage that originated the API request.
        /// </summary>
        public HttpRequestMessage Request { get; private set; }

        /// <summary>
        ///     Gets the HttpResponseMessage to return to the requestor.
        /// </summary>
        public HttpResponseMessage Response { get; private set; }

        /// <summary>
        ///     Gets the route of the original request.
        /// </summary>
        public string Route => Request.RequestUri.PathAndQuery;

        /// <summary>
        ///     Gets a shortened Guid for the request. The lifespan of the request is such that a full length Guid is not necessary.
        /// </summary>
        public string ShortGuid { get; private set; }

        /// <summary>
        ///     Gets or sets the HttpStatusCode to return to the requestor.
        /// </summary>
        ...
        /// <summary>
        ///     Genersates an HttpResponseMessage using the StatusCode, Result object and the supplied JsonMediaTypeFormatter.
        /// </summary>
        ...
        {
            Log(logLevel, "API Request [ID: " + ShortGuid + "]; Route: " + Route + "; Remote IP: " + RemoteIP);
            foreach (var header in Request.Headers)
            {
                Log(logLevel, "\t" + header.Key.ToString() + ": " + Request.Headers.GetValues(header.Key).FirstOrDefault());
            }
        }

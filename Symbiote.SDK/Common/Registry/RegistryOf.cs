...
namespace Symbiote.SDK
{
    ...
    public class Registry<TKey> : IRegistry<TKey>
    {
        /// <summary>
        ...
        public Registry()
        {
            Registrants = new List<TKey>();
        }

        /// <summary>
        ///     Gets the Registry <see cref="List{T}"/>.
        /// </summary>
        public List<TKey> Registrants { get; private set; }
        ...
        public Result Register(TKey key)
        {
            Result retVal = new Result();

            if (Registrants.Contains(key))
            {

...
namespace OpenIIoT.SDK.Security
{
    ...
    public class Ticket
    {
        ...
        /// <summary>
        ///     Initializes a new instance of the <see cref="Ticket"/> class with the specified <paramref name="identity"/> and <paramref name="issuedUtc"/>.
        /// </summary>
        /// <param name="identity">The <see cref="ClaimsIdentity"/> instance associated with the Ticket.</param>
        /// <param name="issuedUtc">The time at which the Ticket was issued, in UTC.</param>
        public Ticket(ClaimsIdentity identity, DateTimeOffset issuedUtc)
        {
            Identity = identity;
            IssuedUtc = issuedUtc;
        }

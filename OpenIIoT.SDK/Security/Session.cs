...
namespace OpenIIoT.SDK.Security
{
    ...
    public class Session
    {
        ...
        public Session(User user, ClaimsIdentity ticket)
        {
            User = user;
            Ticket = ticket;
        ...
        public bool IsExpired => (Expires ?? default(DateTimeOffset)) < DateTime.UtcNow;
        ...
        public ClaimsIdentity Ticket { get; }
        ...
        {
            return Ticket?.Claims?.Where(c => c.Type == type).FirstOrDefault()?.Value;
        }

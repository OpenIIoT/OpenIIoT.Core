/*
 ...
 █████████████████████████████████████████████████████████████ ███████████████ ██  ██ ██   ████ ██     ██     ████████████████ █ █
      ▄
      █  Exceptions for the Configuration namespace.
      █
      █▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀ ▀▀▀▀▀▀▀▀▀▀▀ ▀ ▀▀▀     ▀▀               ▀
...
{
    /// <summary>
    ///     Represents errors that occur within the Configuration namespace.
    /// </summary>
    ...
    /// <summary>
    ///     Represents errors that occur during the load of the application configuration file.
    /// </summary>
    [ExcludeFromCodeCoverage]
    [Serializable]
    public class ConfigurationLoadException : ConfigurationException
    {
        #region Public Constructors
        ...
        /// <summary>
        ///     Initializes a new instance of the <see cref="ConfigurationLoadException"/> class with a specified error message and
    ...
    /// <summary>
    ///     Represents errors that occur during registration of configurable Types.
    /// </summary>
    [ExcludeFromCodeCoverage]
    [Serializable]
    public class ConfigurationRegistrationException : ConfigurationException
    {
        #region Public Constructors
        ...
        /// <summary>
        ///     Initializes a new instance of the <see cref="ConfigurationRegistrationException"/> class with a specified error

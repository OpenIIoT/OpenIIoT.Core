...
namespace OpenIIoT.Core.Tests.Common
{
    ...
    /// <summary>
    ///     Mocks a Manager which throws an exception in the <see cref="Manager.Shutdown(StopType)"/> method.
    /// </summary>
    /// <remarks>
    ///     It is not feasible to use a mocking framework for this mockup due to the access level of the Shutdown() method.
    /// </remarks>
    public class ManagerMockBadShutdown : Manager
    {
        #region Private Fields
    ...
    /// <summary>
    ///     Mocks a Manager which throws an exception in the <see cref="Manager.Startup"/> method.
    /// </summary>
    /// <remarks>
    ///     It is not feasible to use a mocking framework for this mockup due to the access level of the Startup() method.
    /// </remarks>
    public class ManagerMockBadStartup : Manager
    {
        #region Private Fields
    ...
    /// <summary>
    ///     Mocks a Manager which returns a failing Result from the <see cref="Manager.Shutdown(StopType)"/> method.
    /// </summary>
    /// <remarks>
    ///     It is not feasible to use a mocking framework for this mockup due to the access level of the Shutdown() method.
    /// </remarks>
    public class ManagerMockFailingShutdown : Manager
    {
        #region Private Constructors
    ...
    /// <summary>
    ///     Mocks a Manager which returns a failing Result from the <see cref="Manager.Startup"/> method.
    /// </summary>
    /// <remarks>
    ///     It is not feasible to use a mocking framework for this mockup due to the access level of the Startup() method.
    /// </remarks>
    public class ManagerMockFailingStartup : Manager
    {
        #region Private Constructors
    ...
    ///     It is not feasible to use a mocking framework for this mockup due to the implementation of the Singleton pattern.
    /// </remarks>
    public class ManagerMockTwo : Manager
    {
        #region Private Fields
    ...
    public class ManagerTests
    {
        ...
        /// <summary>
        ///     Tests the <see cref="Manager.AutomaticRestartPending"/> property.
        /// </summary>
        ...
        /// <summary>
        ///     Tests the <see cref="Manager.EventProviderName"/> property.
        /// </summary>
        /// <remarks>Depends upon the <see cref="ManagerMock"/> class to simulate the behavior under test.</remarks>
        [Fact]
        ...
        /// <summary>
        ///     Tests the <see cref="Manager.ManagerName"/> property.
        /// </summary>
        /// <remarks>Depends upon the <see cref="ManagerMock"/> class to simulate the behavior under test.</remarks>
        [Fact]
        ...
        /// <summary>
        ///     Tests the <see cref="Manager.Shutdown(StopType)"/> method.
        /// </summary>
        [Fact]
        ...
        /// <summary>
        ///     Tests the <see cref="Manager.Startup"/> method.
        /// </summary>
        [Fact]
        public void Startup()
        {
        ...
        /// <summary>
        ///     Tests the <see cref="Manager.State"/> property.
        /// </summary>
        /// <remarks>Depends upon the <see cref="ManagerMock"/> class to simulate the behavior under test.</remarks>
        [Fact]
